    ...
    <div class="row" style="margin: 0 50px;">
        ...
        <div class="col-md-9">
            <div class="box contour-gris grand" style="margin: 40px 0 70px;">
                <h1 class="titre-box">Intéractions/échanges avec ce complexe</h1>
                    ...
                    <form id="form-interaction">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select id="inputTypeE" class="form-control">
                                    <optgroup label="Type d'échange">
                                        <?php $listeTypes = getEchangesTypes();
